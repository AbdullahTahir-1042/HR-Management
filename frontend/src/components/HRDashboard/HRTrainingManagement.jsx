...
import { Plus, Pencil, Trash2, X, MonitorPlay, Loader2, AlertTriangle, Video, Search, Check, Play, FileText, Image as ImageIcon, File } from 'lucide-react';
        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto min-h-screen space-y-6">
            ...
            {loading ? (
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 p-12 text-center">
                    {(() => {
                        const EmptyIcon = filterOptions.find(f => f.id === filterType)?.icon || Video;
                            ...
                            <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="Document">Document (Word, Excel, etc.)</option>
                                ...
                                {formData.resourceType === 'Video' ? (
                                    ...
                                    <div>
                                        ...
                                        />
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Paste a link to the {formData.resourceType.toLowerCase()} (e.g., Google Drive, SharePoint).</p>
                                    </div>
                                )}
