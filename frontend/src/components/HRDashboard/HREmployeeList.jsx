                        ...
                        >
                            <div>
                                <div className="flex items-start justify-between gap-3 mb-4">
                                    ...
                                    <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shrink-0 ${emp.status === 'full time' ? 'bg-emerald-50 text-emerald-600 border border-emerald-200' : emp.status === 'Inactive' ? 'bg-rose-50 text-rose-600 border border-rose-200' : 'bg-amber-50 text-amber-600 border border-amber-200'
                                        }`}>
                                        {emp.status || 'full time'}
                                    </span>
                                </div>
