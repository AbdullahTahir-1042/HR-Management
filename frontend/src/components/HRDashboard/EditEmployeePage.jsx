...
import {
    ...
    TrendingUp, Award, CheckCircle2, Trash2, FileText, CalendarDays, Clock
} from 'lucide-react';
    ...
    useEffect(() => {
        if (employee) {
            setFormData({
                ...
                shiftDetails: {
                    startTime: employee.shiftDetails?.startTime || '09:00',
                    endTime: employee.shiftDetails?.endTime || '19:00',
                    gracePeriod: employee.shiftDetails?.gracePeriod || 0
                }
            });
