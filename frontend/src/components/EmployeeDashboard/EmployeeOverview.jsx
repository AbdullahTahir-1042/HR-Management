        ...
        >
            ...
            <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4 max-w-6xl">
                    ...
                    <motion.div whileHover={{ y: -4 }} onClick={() => navigate(`/employee/${user?._id}`)} className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm cursor-pointer transition-all group hover:border-indigo-300 dark:hover:border-indigo-500 hover:shadow-md flex flex-col items-center justify-center gap-3 text-center relative">
                    ...
                    {user?.isTeamLead && (
                        <motion.div whileHover={{ y: -4 }} onClick={() => navigate(`/employee/${user?._id}`)} className="bg-amber-50 dark:bg-amber-500/10 p-4 rounded-2xl border border-amber-200 dark:border-amber-500/20 shadow-sm cursor-pointer transition-all group hover:border-amber-400 dark:hover:border-amber-500/50 hover:shadow-md flex flex-col items-center justify-center gap-3 text-center">
