        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto min-h-screen space-y-6">
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-slate-900">No training resources found</h3>
                    <p className="text-slate-500 mt-1">You are all caught up! Check back later for new materials.</p>
                </div>
            ) : (
                    ...
                    {filteredVideos.map((video, index) => (
                        ...
                        >
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                <h3 className="font-semibold text-slate-900 text-lg mb-2" title={video.title}>{video.title}</h3>
