...
import { Megaphone, Calendar, User, Plus, Trash2, X, Loader2, ArrowLeft } from 'lucide-react';
                    ...
                    <div className="flex items-start justify-between gap-4">
                        ...
                        {isHR && (
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold text-red-500 hover:bg-red-50 transition-all shrink-0"
                            >
                                <Trash2 size={15} />
                                Delete
                            </button>
